...
- `a6ce7d7` — `feat(ui): extract shared brand and social icons`
- `42afb63` — `feat(ui): add Button component with primary and secondary variants`
- `50b4cec` — `feat(footer): implement structured 4-column footer`
