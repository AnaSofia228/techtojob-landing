...
/** Trophy outline: challenges and prizes. */
export function TrophyGlyph({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`${className} shrink-0`}
...
/** LinkedIn "in" mark (Font Awesome Free, CC BY 4.0). */
export function LinkedInGlyph({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`${className} shrink-0`}
...
/** Instagram mark (simple-icons, MIT). */
...
/** Hashtag icon (Lucide hash): channel. */
export function HashGlyph({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`${className} shrink-0`}
...
/** Envelope icon (Lucide mail): newsletter CTA. */
export function MailGlyph({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`${className} shrink-0`}
...
/** Padlock icon (Lucide lock): no-spam reassurance. */
